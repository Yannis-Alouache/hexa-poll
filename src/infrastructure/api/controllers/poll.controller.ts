...
export class PollController {
    ...
    @Post("/update")
    async updatePoll(@Body() updatePollRequest: UpdatePollCommand): Promise<UpdatePollResponse> {
        return this.commandBus.execute(
    ...
    @Delete()
    async deletePoll(@Body() deletePollRequest: DeletePollCommand): Promise<void> {
        return this.commandBus.execute(
